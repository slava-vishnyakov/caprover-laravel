...
services:
  ...
  postgres:
    ...
    # DB_URL=postgres://webapp:secret@localhost:{{ $postgresPort }}/webapp?sslmode=disable
  ...
  postgres_test:
    ...
    # DB_URL=postgres://webapp:secret@localhost:{{ $testDbPostgresPort }}/webapp?sslmode=disable
    image: postgres:{{ $postgresVersion }}
    ports:
